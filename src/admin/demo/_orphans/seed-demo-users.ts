// Server function to seed demo users + 2 demo shops with full data.
...
const DEMO_USERS: SeedUser[] = [
  ...
  { email: "staff@inkwell.app", full_name: "Marcus Chen", role: "staff" },
];
...
const SHOPS: ShopSeed[] = [
  {
    ...
    staff: [
      { id: "00000000-0000-0000-0002-000000000001", full_name: "Sophia Reyes", email: "owner@inkwell.app" },
  ...
  },
  {
    ...
    staff: [
      { id: "00000000-0000-0000-0012-000000000001", full_name: "James van Dijk" },
...
async function seedShop(shop: ShopSeed, ownerId: string, bookings: BookingPlan[]) {
...
export const seedDemoUsers = createServerFn({ method: "POST" }).handler(async () => {
  ...
  await seedShop(SHOPS[0], inkwellOwnerId, BOOKINGS_INKWELL);
  await seedShop(SHOPS[1], inkwellOwnerId, BOOKINGS_SHARP);
  ...
  return { ok: true, results, password: PASSWORD, shops: [SHOP_INKWELL, SHOP_SHARP] };
});
