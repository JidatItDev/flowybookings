export const nl: Record<string, string> = {
  ...
  "calendar.visualStatus.paymentPending": "Wacht op betaling",
  "calendar.visualStatus.confirmationPending": "Bevestiging nodig",
  "calendar.needsAttention": "vraagt je aandacht",
  "calendar.needsAttentionNone": "Niets vraagt aandacht",
  "calendar.legendTitle": "Statuslegenda",
  ...
  "services.depositModeDefault": "Standaard % van shop",
  "services.depositModeCustom": "Vast bedrag",
  "services.depositModeDefaultNote": "Gebruikt de standaard aanbetaling van de shop ({percent}%) bij het boeken.",
  ...
  "settings.mollieManageTitle": "Mollie betalingen beheren",
  "settings.mollieManageDesc": "Koppel of beheer je Mollie-account op de betalingenpagina.",
  "settings.mollieManageCta": "Naar Betalingen →",
  ...
  "book.payNow": "Betaal {amount} nu",
  "book.confirmFree": "Bevestig afspraak",
  "book.freeNotice": "Geen betaling nodig — je ontvangt direct een bevestiging per e-mail.",
  "book.depositBadge": "{amount} aanbetaling",
  "book.noDepositBadge": "Geen aanbetaling",
  "book.dueNow": "Nu verschuldigd",
  "book.autoAssigned": "wordt automatisch toegewezen",
  ...
  "book.price": "Prijs",
  "book.depositDue": "Aanbetaling nu verschuldigd",
  "book.remainingAtAppointment": "Resterend bij afspraak",
  "book.depositNotice":
    "Je betaalt nu een aanbetaling van {deposit} om deze boeking te bevestigen — het resterende bedrag van {remaining} betaal je bij je afspraak.",
  "book.back": "Terug",
  ...
  "status.payment_pending": "Wacht op betaling",
  "status.confirmation_pending": "Bevestiging nodig",
  ...
  "calendar.paymentSectionTitle": "Betaling",
  "calendar.bookingSummary": "Samenvatting",
  "calendar.totalPrice": "Totaalprijs",
  "calendar.depositAmount": "Aanbetaling",
  "calendar.dueAtAppointment": "Te betalen bij afspraak",
  "calendar.noDepositRequired": "Geen aanbetaling vereist — volledig bedrag te betalen bij de afspraak.",
  "calendar.noOnlinePaymentManual": "Handmatige boeking — geen online betaling; aanbetaling in persoon afhandelen.",
  "calendar.manualBookingBadge": "Handmatig",
  "calendar.onlineBookingBadge": "Online",
  ...
  "calendar.remainingBalance": "Nog te betalen",
  "calendar.unassigned": "Niet toegewezen",
  "calendar.appointmentDetails": "Afspraak details",
  "calendar.allergyNote": "Allergie / aandachtspunt",
  "calendar.viewDay": "Dag",
  "calendar.viewWeek": "Week",
  "calendar.viewWeekDisabledMobile": "Week-weergave alleen op tablet/desktop",
  "calendar.viewGrid": "Rooster",
  "calendar.viewGridDisabledPickDay": "Kies een dag om het rooster te tonen",
  "calendar.viewList": "Lijst",
  "calendar.prevWeek": "Vorige week",
  "calendar.nextWeek": "Volgende week",
  "calendar.jumpToThisWeek": "Naar deze week",
  "calendar.thisWeek": "Deze week",
  "calendar.staffOffToday": "{staff} werkt vandaag niet",
  "calendar.unavailableStaffOffToday": "Niet beschikbaar — {staff} werkt vandaag niet",
  "calendar.outsideHours": "Buiten werkuren",
  "calendar.outsideHoursRangeCompact": "Buiten werkuren {range}",
  "calendar.outsideHoursStaffRange": "Buiten werkuren — {staff} werkt {range}",
  "calendar.break": "Pauze",
  "calendar.breakRangeCompact": "Pauze {range}",
  "calendar.unavailableStaffTime": "Niet beschikbaar — {staff} {time}",
  "calendar.newBookingStaffTime": "Nieuwe boeking {staff} {time}",
  "calendar.dragOrKeysToMove": "Sleep of gebruik pijltjestoetsen om te verplaatsen",
  "calendar.arrowKeysHint": "Pijltjes om ±15 min of medewerker-kolom te verplaatsen",
  "calendar.openDayView": "Open dag-weergave",
  "calendar.shopClosed": "Salon gesloten",
  "calendar.arrowKeysMove": "Pijltjes om te verplaatsen",
  ...
  "calendar.cancelActionTitle": "Deze boeking annuleren?",
  "calendar.cancelActionDesc": "De klant wordt per e-mail op de hoogte gebracht. Dit kan niet ongedaan worden gemaakt.",
  "calendar.cancelBooking": "Boeking annuleren",
  "calendar.cancelReasonLabel": "Reden voor annulering",
  "calendar.cancelReasonPlaceholder": "bijv. klant heeft gevraagd, medewerker niet beschikbaar…",
  "calendar.capturedAmount": "Geïncasseerd bedrag",
  "calendar.completedActionTitle": "Markeren als voltooid?",
  "calendar.completedActionDesc": "De klant wordt hier niet over geïnformeerd.",
  "calendar.confirmActionTitle": "Deze boeking bevestigen?",
  "calendar.confirmActionDesc": "De klant ontvangt een bevestigingsmail.",
  "calendar.actionConfirmBooking": "Boeking bevestigen",
  "calendar.actionMarkCompleted": "Markeren als voltooid",
  "calendar.actionMarkConfirmed": "Markeren als bevestigd",
  "calendar.actionMarkNoShow": "Markeren als no-show",
  "calendar.moreActions": "Meer acties",
  "calendar.noActionsAvailable": "Nu geen acties beschikbaar",
  "calendar.durationMinutesOnly": "{{min}} min",
  "calendar.durationHoursMinutes": "{{h}}u {{m}}m",
  "calendar.confirmMoveAction": "Bevestigen",
  "calendar.confirmMoveTitle": "Verplaatsen naar {{time}}?",
  "calendar.confirmMoveDesc": "De klant wordt per e-mail op de hoogte gebracht.",
  "calendar.confirmResizeTitle": "Eindtijd wijzigen naar {{time}}?",
  "calendar.confirmResizeDesc": "Er wordt geen e-mail verstuurd — de starttijd verandert niet.",
  "calendar.genericError": "Er is iets misgegaan. Probeer het opnieuw.",
  "calendar.noShowActionTitle": "Markeren als no-show?",
  "calendar.noShowActionDesc": "De klant wordt hier niet over geïnformeerd.",
  "calendar.refundedBadge": "Terugbetaald",
  "calendar.undoActionTitle": "Opnieuw markeren als bevestigd?",
  "calendar.undoActionDesc": "De klant wordt hier niet over geïnformeerd.",
  "calendar.guardReason.booking_already_started": "Deze afspraak is al begonnen.",
  "calendar.guardReason.booking_not_started_yet": "Deze afspraak is nog niet begonnen.",
  "calendar.guardReason.booking_not_ended_yet": "Deze afspraak is nog niet afgelopen.",
  "calendar.guardReason.payment_in_progress": "Wachten tot de online betaling is voltooid.",
  "calendar.guardReason.invalid_current_status": "Deze actie is niet beschikbaar voor de huidige status.",
  "calendar.guardReason.missing_reason": "Een reden is verplicht.",
  "calendar.guardReason.unauthenticated": "Je moet opnieuw inloggen.",
  "calendar.guardReason.forbidden": "Je hebt hier geen toestemming voor.",
  "calendar.guardReason.booking_not_found": "Deze boeking kon niet worden gevonden.",
  "calendar.guardReason.status_changed": "Deze boeking is zojuist elders gewijzigd — probeer het opnieuw.",
  "calendar.guardReason.invalid_action": "Die actie wordt niet herkend.",
  ...
  "billing.pendingPayment": "Betaling in behandeling: {{amount}} — Mollie int op {{date}}",
